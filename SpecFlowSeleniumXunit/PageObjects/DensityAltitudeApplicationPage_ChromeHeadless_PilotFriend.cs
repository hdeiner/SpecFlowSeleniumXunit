...
{
    class DensityAltitudeApplicationPage_ChromeHeadless_PilotFriend : IDisposable, DensityAltitudeApplicationPage
    {
        ...
        public DensityAltitudeApplicationPage_ChromeHeadless_PilotFriend()
        {
