...
{
    class DensityAltitudeApplicationPage_Edge_PilotFriend : IDisposable, DensityAltitudeApplicationPage
    {
        ...
        public DensityAltitudeApplicationPage_Edge_PilotFriend()
        {
