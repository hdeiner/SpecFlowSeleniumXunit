...
{
    class DensityAltitudeApplicationPage_Edge_ShelquistEngineering : IDisposable, DensityAltitudeApplicationPage
    {
        ...
        public DensityAltitudeApplicationPage_Edge_ShelquistEngineering()
        {
            System.Environment.SetEnvironmentVariable("webdriver.edge.driver", @"bin/debug/MicrosoftWebDriver.exe");
