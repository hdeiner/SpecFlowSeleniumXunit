...
{
    public class DensityAltitudeApplicationPage_Firefox_PilotFriend : IDisposable, DensityAltitudeApplicationPage
    {
        ...
        public DensityAltitudeApplicationPage_Firefox_PilotFriend()
        {
