...
{
    class DensityAltitudeApplicationPage_Firefox_ShelquistEngineering : IDisposable, DensityAltitudeApplicationPage
    {
        ...
        public DensityAltitudeApplicationPage_Firefox_ShelquistEngineering()
        {
            System.Environment.SetEnvironmentVariable("webdriver.gecko.driver", @"bin/debug/geckodriver.exe");
