...
{
    class DensityAltitudeApplicationPage_InternetExplorer_PilotFriend : IDisposable, DensityAltitudeApplicationPage
    {
        ...
        public DensityAltitudeApplicationPage_InternetExplorer_PilotFriend()
        {
